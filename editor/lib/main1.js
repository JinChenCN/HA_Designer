...
function returnModelInfoInJasonFormat()
{
    ...
    example: 
    { "modelName": "abc", 
    "edges":[{"id":"1","events":["abc",""],"guards":["123","345"], "startLocation":{"id":"1", "text":"abc"}, "endLocation":{"id":"2", "text":"abcd"} }, 
             {"id":"2","events":["abc",""],"guards":["123","345"], "startLocation":{"id":"3", "text":"abc"}, "endLocation":{"id":"4", "text":"abcd"} }
            ], 
    "locations": [
    {"id":"1", "text":"abc"},
    {"id":"2", "text":"abc"},
    ...
    for (var i = 0; i < CONNECTOR_MANAGER.connectors.length ; i++) {
        ...
        edgeStr += ",\"startLocation\":{\"id\":\"" + startFigure.id + "\", \"text\":\"" + returnFigureText(startFigure) + "\"}";
        edgeStr += ",\"endLocation\":{\"id\":\"" + endFigure.id + "\", \"text\":\"" + returnFigureText(endFigure) + "\"}";
        //primitives
    ...
    for (var i = 0; i < STACK.figures.length; i++)
    {
        ...
        locationStr += "{\"id\":\"" + obj.id + "\", \"text\":\"" + returnFigureText(obj) + "\"}";
